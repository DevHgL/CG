...
// FUNÇÕES HELPER PARA IGNORAR NAN (A CORREÇÃO PRINCIPAL)
...
// Versão final e robusta da função de interseção
...
// Versão do SCANLINE CORRIGIDA para usar nan_min e nan_max
template<class Tri>
